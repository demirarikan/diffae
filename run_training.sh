...
#SBATCH --output=checkpoint/diffae-%A.out # Standard output of the script (Can be absolute or relative path). %A adds the job id to the file name so you can launch the same script multiple times and get different logging files
...
# run the script
python us_training.py --login 48bbbe5c57a936ef9247a8de2537af5b86e5694e --datatype real --dataset 
